<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreboardingViewApplication.aspx.cs" Inherits="CAPRES.PreboardingViewApplication" %>
...
<body>
    ...
    <div>
        ...
        <asp:Button ID="btnHire" runat="server" Text="Hire Candidate" 
            onclick="btnHire_Click" />&nbsp
        <asp:Button ID="btnDelete" runat="server" Text="Delete Candidate" 
